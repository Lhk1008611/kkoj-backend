...
import com.lhk.kkoj.model.dto.question.QuestionQueryRequest;
import com.lhk.kkoj.model.entity.Question;
import com.lhk.kkoj.model.entity.User;
import com.lhk.kkoj.model.vo.QuestionVO;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    public QueryWrapper<Question> getQueryWrapper(QuestionQueryRequest questionQueryRequest) {
        ...
        queryWrapper.eq(ObjectUtils.isNotEmpty(creatorId), "userId", creatorId);
    ...
    public QuestionVO getQuestionVO(Question question, HttpServletRequest request) {
        ...
        questionVO.setCreatorVO(userVO);
        return questionVO;
    }
    ...
    public Page<QuestionVO> getQuestionVOPage(Page<Question> questionPage, HttpServletRequest request) {
        ...
        List<QuestionVO> questionVOList = questionList.stream().map(question -> {
            ...
            questionVO.setCreatorVO(userService.getUserVO(creator));
            return questionVO;
